...
initial_conditions = [1.0, 5, -1.0, 3]  # Angle_1, Velocity_1, Angle_2, Velocity_2,
m1_val = 2
m2_val = 2
g_val = 9.81
...
mass1, = ax.plot([x1_pendulum[0]], [y1_pendulum[0]], 'o', markersize=4 * int(m1_val) + 1, color='blue')
...
mywriter=an.PillowWriter(fps=30)
animation.save("model3.gif", writer=mywriter)
plt.show()